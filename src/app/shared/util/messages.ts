export class Messages {
    public static msgErrorServer: string = 'Error en el servidor: ';
     
    public static msgRegisterSuccess: string = 'Registro exitoso, por favor ingresa con tus nuevas credenciales';
